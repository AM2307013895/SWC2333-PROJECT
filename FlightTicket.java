...
public class FlightTicket extends JFrame implements ActionListener {
    JComboBox<String> adultTickets, kidTickets;
    JButton submitButton;
    String selectedAirport;

    public FlightTicket(String selectedAirport) {
        this.selectedAirport = selectedAirport;
        // Create a title for the flight ticket
        setTitle("Flight Ticket - " + selectedAirport);
        setSize(400, 300);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submitButton) {
            ...
            // Launch InternationalFare.java with the selected destination
            new InternationalFare(selectedAirport, adultTicketsSelected, kidTicketsSelected);
            dispose(); // Close the FlightTicket window
        }
    }

    public static void main(String[] args) {
        // This main method is not needed in this case,
        // as the FlightTicket window is launched from InternationalRoutes.java
    }
}